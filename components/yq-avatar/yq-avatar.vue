		...
		<view class="oper-wrapper" :style="{display: sD, top:tp}">
			<view class="oper">
				<view class="btn-wrapper" v-if="sO">
					<view @click="fSelect" hover-class="hover" :style="{width: bW}"><text style="font-size: 26upx;">{{$t('Select')}}</text></view>
					<view @click="fClose" hover-class="hover" :style="{width: bW}"><text style="font-size: 26upx;">{{$t('Close')}}</text></view>
					<view @click="fRotate" hover-class="hover" :style="{width: bW, display: bD}"><text style="font-size: 26upx;">{{$t('Rotate')}}</text></view>
					<view @click="fPreview" hover-class="hover" :style="{width: bW}"><text style="font-size: 26upx;">{{$t('Preview')}}</text></view>
					<view @click="fUpload" hover-class="hover" :style="{width: bW}"><text style="font-size: 26upx;">{{$t('Upload')}}</text></view>
				</view>
				<view class="clr-wrapper" v-else>
					...
					<view @click="fPrvUpload" hover-class="hover" :style="{width: bW}"><text style="font-size: 26upx;">{{$t('Upload')}}</text></view>
				</view>
			</view>
		</view>
	</view>
				...
				uni.chooseImage({
					...
					success: (r) => {
						...
						uni.getImageInfo({
							...
							success: r => {
								...
								if (!this.hasSel) {
									...
									if (this.selWidth && this.selHeight) {
										...
										uni.showModal({
											title: this.$t('Please set the crop box'),
											showCancel: false
										})
										return;
									}
							...
							fail: () => {
								uni.showToast({
									title: this.$t('Please select the correct image'),
									duration: 2000,
								})
							},
							complete() {
